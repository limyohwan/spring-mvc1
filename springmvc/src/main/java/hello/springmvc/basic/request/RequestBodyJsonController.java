...
public class RequestBodyJsonController {
    ...
    public void requestBodyJsonV1(HttpServletRequest request, HttpServletResponse response) throws IOException{
        ...
        log.info("requestBodyJsonV1 = {}", messageBody);
    ...
    public String requestBodyJsonV2(@RequestBody String messageBody) throws JsonMappingException, JsonProcessingException {
        log.info("requestBodyJsonV2 = {}", messageBody);
    ...
    public String requestBodyJsonV3(@RequestBody HelloData helloData) {
        log.info("requestBodyJsonV3 username = {}, age = {}", helloData.getUsername(), helloData.getAge());
